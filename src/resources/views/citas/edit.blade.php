                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('citas.update', $cita) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="duracion_estimada" id="duracion_estimada" class="w-full border-gray-300 rounded-md shadow-sm" min="1" value="{{ old('duracion', $cita->duracion_estimada) }}" required>
                            @error('duracion')
                                <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
